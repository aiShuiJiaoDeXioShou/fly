...
.phone {
  ...
  overflow: hidden;
  padding: 2rem;
  box-shadow: 0 0 0 10px @c-gray-300, 0 0 0 11px @c-gray-200;
...
.search-button {
  ...
  position: relative;
  height: 100%;
  border-right: 2px solid @c-gray-900;
  width: 70px;
  transition: 0.15s ease;
  cursor: pointer;
...
.navigation {
  ...
  border-bottom: 1px solid @c-gray-900;
  display: flex;
  justify-content: space-between;
}
